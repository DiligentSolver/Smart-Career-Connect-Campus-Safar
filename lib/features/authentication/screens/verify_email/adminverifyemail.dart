...
import 'package:campus_safar/features/authentication/controllers/email_verification.controller/adminEmailVerify_controller.dart';
...
class AdminVerifyEmail extends StatefulWidget {
  const AdminVerifyEmail({super.key});

  @override
  State<AdminVerifyEmail> createState() => _AdminVerifyEmailState();
}

class _AdminVerifyEmailState extends State<AdminVerifyEmail> {
  @override
  void initState() {
  ...
  final emailverify = Get.put(AdminEmailVerification());
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    ...
                    emailverify.adminCheckEmailVerificationStatus();
