...
import '../../controllers/email_verification.controller/studentEmailVerify_controller.dart';

class StudentVerifyEmail extends StatefulWidget {
  const StudentVerifyEmail({super.key});

  @override
  State<StudentVerifyEmail> createState() => _StudentVerifyEmailState();
}

class _StudentVerifyEmailState extends State<StudentVerifyEmail> {
  @override
  dispose() {
  ...
  final emailverify = Get.put(StudentEmailVerification());
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    ...
                    emailverify.studentCheckEmailVerificationStatus();
