...
class AnimatedCircle extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint();
    fillBrush.color = CSColors.fourthColor.withOpacity(opacity);

    var largeCircle = Paint();
    largeCircle.style = PaintingStyle.stroke;
    largeCircle.strokeWidth = 1.0;
    largeCircle.color =
        (value <= 140 && value > 125) ? CSColors.fifthColorShade : CSColors.fifthColorShade;

    var mediumCircle = Paint();
    mediumCircle.style = PaintingStyle.stroke;
    mediumCircle.strokeWidth = 1.0;
    mediumCircle.color =
        (value > 90 && value < 110) ? CSColors.fifthColorShade : CSColors.fifthColorShade;

    var xSmallCircle = Paint();
    xSmallCircle.style = PaintingStyle.stroke;
    xSmallCircle.strokeWidth = 1.0;
    xSmallCircle.color =
        (value > 40 && value < 60) ? CSColors.fifthColorShade : CSColors.fifthColorShade
    ;

    var childDot = Paint();
    childDot.color = CSColors.fifthColor;

    var centerDot = Paint();
    centerDot.color = CSColors.fifthColorShade;
